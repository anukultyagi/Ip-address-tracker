            ...
            apiData && (
              <div className='rounded-xl sm:mb-10 mb-8 bg-white dark:bg-stone-800 dark:text-white p-3 sm:px-5 max-w-4xl mx-3 sm:mx-auto flex sm:flex-row flex-col justify-between sm:items-center transition-all duration-500'>
                <div className='mb-4 sm:mb-0'>
                  <p className='mb-2 sm:mb-4 font-mono font-extrabold text-center sm:text-left uppercase text-stone-500 text-sm tracking-wider'>IP Address</p>
                  <p className='text-2xl font-bold'>{apiData.ip ? apiData.ip : 'Unknown'}</p>
                </div>
                <div className='mb-4 sm:mb-0'>
                  <p className='mb-2 sm:mb-4 font-mono font-extrabold text-center sm:text-left uppercase text-stone-500 text-sm tracking-wider'>Location</p>
                  <p className='text-2xl font-bold'>
                    {`${apiData.location.city}, ${apiData.location.country}, ${apiData.location.postalCode}`}
                  </p>
                </div>
                <div className='mb-4 sm:mb-0'>
                  <p className='mb-2 sm:mb-4 font-mono font-extrabold text-center sm:text-left uppercase text-stone-500 text-sm tracking-wider'>Timezone</p>
                  <p className='text-2xl font-bold'>{apiData.location.timezone ? apiData.location.timezone : "NA"}</p>
                </div>
                <div className='mb-4 sm:mb-0'>
                  <p className='mb-2 sm:mb-4 font-mono font-extrabold text-center sm:text-left uppercase text-stone-500 text-sm tracking-wider'>ISP</p>
